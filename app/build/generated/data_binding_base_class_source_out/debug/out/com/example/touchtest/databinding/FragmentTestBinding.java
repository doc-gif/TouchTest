...
public final class FragmentTestBinding implements ViewBinding {
  ...
  private FragmentTestBinding(@NonNull ConstraintLayout rootView, @NonNull TextView current,
      @NonNull ConstraintLayout frameLayout, @NonNull TextView question,
      @NonNull TextView textView4, @NonNull TextView total) {
  ...
  public static FragmentTestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTestBinding((ConstraintLayout) rootView, current, frameLayout, question,
          textView4, total);
    }
